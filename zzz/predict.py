...
def print_2d_array_to_file(filename, data):
...
def load_and_predict(model_filename='trained_model.pkl', packet_count=100):
    ...
    # print_2d_array_to_file('predictions.txt', df.to_string(index=True))
    
    print("The predictions are printed in the predictions.txt file")
    print(df)
